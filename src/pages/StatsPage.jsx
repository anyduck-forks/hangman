    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-4">
      <div className="bg-gray-800 p-8 rounded-xl shadow-2xl w-full border border-gray-700">
        ...
        <div className="flex justify-center gap-4 pt-4">
          <Button
            onClick={onRestart}
            className="px-8 py-3 text-lg bg-blue-600 hover:bg-blue-500"
          >
            Play Again
          </Button>
          <Button
            onClick={onMenu}
            className="px-8 py-3 text-lg bg-gray-700 hover:bg-gray-600"
          >
            Menu
          </Button>
        </div>
      ...
      >
        <div className="flex flex-col items-center text-white p-4">
          ...
          <div className="flex flex-col gap-3 w-full max-w-xs">
            <Button
              onClick={onRestart}
              className="w-full py-3 text-lg bg-blue-600 hover:bg-blue-500"
            >
              Play Again
            </Button>
            <Button
              onClick={onMenu}
              className="w-full py-3 text-lg bg-gray-700 hover:bg-gray-600"
            >
              Menu
            </Button>
          </div>
