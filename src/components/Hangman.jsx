export default function Hangman({ lives = 0 }) {
  const parts = [
    ...
    <line key="pole" x1="80" y1="250" x2="80" y2="20" stroke="white" strokeWidth="4" />,
    <line key="top" x1="80" y1="20" x2="200" y2="20" stroke="white" strokeWidth="4" />,
    <line key="rope" x1="200" y1="20" x2="200" y2="50" stroke="white" strokeWidth="4" />,
    // Head
    ...
    // Legs
    <line key="l-leg" x1="200" y1="170" x2="170" y2="220" stroke="white" strokeWidth="4" />,
    <line key="r-leg" x1="200" y1="170" x2="230" y2="220" stroke="white" strokeWidth="4" />,
  ];
